                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group  {{ $errors->has('content') ? ' has-error' : '' }}">
                                ...
                                <textarea class="form-control " id="content" name="content"
                                          style="width: 40%; height: 150px; font-size: 14px; line-height: 18px;border-radius: 1px; border: 1px  solid #dddddd; padding: 10px;">{{ $about->content }}</textarea>
                            ...
                            <div class="form-group  {{ $errors->has('img') ? ' has-error' : '' }}">
                                ...
                                <input type="file" name="img" multiple class="form-control-file" id="img" aria-describedby="fileHelp" value="{{$about->img}}">
                                <img class="card-img-top" src="{{ asset('imgs/aboutUs/' . $about->img) }} " style="width:150px;height:150px;" >
